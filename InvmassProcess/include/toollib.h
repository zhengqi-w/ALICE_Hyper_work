...
class tool
{
  public:
    ...
    static void SetTreeBranchAddress(TTree *tree, std::vector<Int_t*>BranchAddress_int, std::vector<Float_t*>BranchAddress_float, std::vector<Double_t*>BranchAddress_double, std::vector<UChar_t*> BranchAddress_uchar, std::vector<UShort_t*> BranchAddress_ushort, std::vector<UInt_t*> BranchAddress_uint, std::vector<Bool_t*> BranchAddress_bool,std::vector<TBranch*>Branches);
    ...
    static Float_t CalculateCosPointingAngle(Float_t x1,Float_t y1,Float_t z1, Float_t px, Float_t py, Float_t pz);
    static Double_t DoubleSidedCrystalballFunctionPol2(double *x, double *par);
    static Double_t SignalFunctionDoubleSidedCrystalball(double *x, double *par);
    static Double_t BackgroundFunctionPol2(double *x, double *par);
};
